...
mkMessage "LoLLogsWebApp" "messages" "en"
...
--
-- * Creates the route datatype LoLLogsWebAppRoute. Every valid URL in your
--   application can be represented as a value of this type.
-- * Creates the associated type:
--       type instance Route LoLLogsWebApp = LoLLogsWebAppRoute
-- * Creates the value resourcesLoLLogsWebApp which contains information on the
--   resources declared below. This is used in Handler.hs by the call to
--   mkYesodDispatch
--
-- What this function does *not* do is create a YesodSite instance for
-- LoLLogsWebApp. Creating that instance requires all of the handler functions
-- for our application to be in scope. However, the handler functions
-- usually require access to the LoLLogsWebAppRoute datatype. Therefore, we
...
instance RenderMessage LoLLogsWebApp FormMessage where
